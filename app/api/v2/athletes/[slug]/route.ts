...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      console.warn(`[V2 Athlete GET detail] DynamoDB get failed for ${slug}:`, dynErr);
    }
    ...
    if (!fetchedFromDynamo) {
      try {
        ...
        console.error(`[V2 Athlete GET detail] Firestore fallback failed for ${slug}:`, fsErr);
      }
    }
