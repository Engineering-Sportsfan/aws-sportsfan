...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      console.warn('[V2 Playbook GET detail] DynamoDB query failed:', dynErr);
    }
    ...
    if (!fetchedFromDynamo) {
      try {
        ...
        console.error('[V2 Playbook GET detail] Firestore fallback failed:', fsErr);
      }
    }
