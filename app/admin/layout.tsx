    ...
    items: [
      {
        ...
        children: [
          {
            href: "/admin/user-management/users/add-user-form",
            label: "Add User",
          },
          {
            href: "/admin/user-management/users/user-list",
            label: "User List",
          },
          {
            href: "/admin/userroles-management/assign-roles",
            label: "User Roles",
          },
          {
            href: "/admin/department-management/add-department-form",
            label: "Add Department",
          },
          {
            href: "/admin/department-management/department-list",
      ...
      },
      {
        ...
        icon: "◉",
        badge: "30+",
        children: [{ href: "/admin/users/signups", label: "Signups" }],
      },
      {
    ...
    items: [
      {
        ...
        children: [
          {
            href: "/admin/store-management/addStore/addCategory",
            label: "Add Category",
          },
          { href: "/admin/store-management/addStore/addCoach", label: "Add Coach" },
          { href: "/admin/store-management/addStore/addEvent", label: "Add Event" },
          {
            href: "/admin/store-management/addStore/addExperience",
            label: "Add Experience",
          },
          { href: "/admin/store-management/addStore/addAuction", label: "Add Auction" },
          { href: "/admin/store-management/addStore/addAthlete", label: "Add Athlete" },
          {
            href: "/admin/store-management/addStore/addMerchandise",
            label: "Add Merchandise",
          },
          { href: "/admin/store-management/addStore/addBrand", label: "Add Brand" },
          {
            href: "/admin/store-management/addStore/addDigitalProduct",
            label: "Add Digital Product",
          },
          {
            href: "/admin/store-management/addStore/addMembership",
      ...
      },
      {
        ...
        children: [
          ...
          {
            href: "/admin/team360-management/team360-list",
            label: "Teams 360 List",
          },
        ],
      },
      {
        label: "Teams 360 Playlist",
        icon: "◉",
        children: [
          {
            href: "/admin/team360playlist-management/add-team360playlist",
            label: "Add Teams 360 Playlist",
          },
          {
            href: "/admin/team360playlist-management/team360playlist-list",
            label: "Teams 360 Playlist List",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            label: "Add Player 360",
          },
          {
            href: "/admin/player360-management/player360-list",
            label: "Player 360 List",
          },
        ],
      },
      {
        label: "Cricket Articles",
        icon: "◉",
        children: [
          {
            href: "/admin/cricketarticles-management/add-cricketarticles",
            label: "Add Cricket Article",
          },
          {
            href: "/admin/cricketarticles-management/cricketarticles-list",
            label: "Cricket Articles List",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/clubprofile-management/add-clubprofile",
            label: "Add Club Profile",
          },
          {
            href: "/admin/clubprofile-management/clubprofile-list",
            label: "Club Profiles List",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/userfeedback-management/add-userfeedback",
            label: "Add User Feedback",
          },
          {
            href: "/admin/userfeedback-management/userfeedback-list",
      ...
      },
      {
        ...
        children: [
          {
            href: "/admin/playerprofile-management/add-playerprofile",
            label: "Add Player Profile",
          },
          {
            href: "/admin/playerprofile-management/playerprofile-list",
            label: "Player Profiles List",
          },
        ],
      },
      {
        label: "Player Profiles Playlist",
        icon: "◉",
        children: [
          {
            href: "/admin/playerprofileplaylist-management/add-playerprofileplaylist",
            label: "Add Player Profiles Playlist",
          },
          {
            href: "/admin/playerprofileplaylist-management/playerprofileplaylist-list",
            label: "Player Profiles Playlist",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/watchalong-management/add-watchalong",
            label: "Add Watch Along",
          },
          {
            href: "/admin/watchalong-management/watchalong-list",
            label: "Watch Along List",
          },
        ],
      },
      {
        label: "Focus Group Matches",
        icon: "◉",
        children: [
          {
            href: "/admin/focusmatch-management/add-focusmatch",
            label: "Add Focus Match",
          },
          {
            href: "/admin/focusmatch-management/focusmatch-list",
            label: "Matches List",
          },
        ],
      },
      {
        label: "RoAR Management",
        icon: "◉",
        children: [
          { href: "/admin/roar-management/add-roar", label: "Add RoAR Show" },
          { href: "/admin/roar-management/roar-list", label: "RoAR Show List" },
          {
            href: "/admin/roar-management/posts-list",
            label: "RoAR Posts & Comments",
          },
          {
            href: "/admin/roar-management/add-prediction",
            label: "Add RoAR Predictions",
          },
          {
            href: "/admin/roar-management/add-trivia",
            label: "Add RoAR Trivia",
          },
          {
            href: "/admin/roar-management/add-battle",
            label: "Add RoAR Battle",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          {
            href: "/admin/hostroom-management/add-hostroom",
            label: "Add Host Room",
          },
          {
            href: "/admin/hostroom-management/hostroom-list",
            label: "Host Room List",
          },
        ],
      },
      {
        label: "Host Login Screen",
        icon: "◉",
        children: [
          {
            href: "/admin/hostloginscreen-management/add-hostroomlogin",
            label: "Add Host Login Form",
          },
          {
            href: "/admin/hostloginscreen-management/hostroomlogin-list",
            label: "Host Members List",
          },
        ],
      },
      {
        label: "Audio Content Screen",
        icon: "◉",
        children: [
          {
            href: "/admin/audiomessages-management",
            label: "Audio Messages List",
          },
          {
            href: "/admin/audiodrops-management/",
            label: "Audio Request Drops List",
          },
          { href: "/admin/audioplaylist-management/", label: "Audio List" },
        ],
      },
      {
        label: "Video Messages Screen",
        icon: "◉",
        children: [
          {
            href: "/admin/videodrops-management/videomessages",
            label: "Video Messages List",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/cricketmatches-management/add-cricketmatches",
            label: "Add Cricket Matches",
          },
          {
            href: "/admin/cricketmatches-management/cricketmatches-list",
            label: "Cricket Matches List",
          },
        ],
      },

      {
        label: "FIFA Players Stats",
        icon: "◉",
        children: [
          {
            href: "/admin/fifaplayerstats-management/add-fifaplayerstats",
            label: "Add FIFA Players Stats",
          },
          {
            href: "/admin/fifaplayerstats-management/fifaplayerstats-list",
            label: "FIFA Players Stats List",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/fifaclub-management/add-fifaclub",
            label: "Add FIFA Club",
          },
          {
            href: "/admin/fifaclub-management/fifaclub-list",
            label: "FIFA Club List",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/wt20club-management/add-wt20club",
            label: "Add WT20 Club",
          },
          {
            href: "/admin/wt20club-management/wt20club-list",
            label: "WT20 Club List",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/fanbattle-management/add-fanbattle",
            label: "Add Fan Battle",
          },
          {
            href: "/admin/fanbattle-management/fanbattle-list",
            label: "Fan Battle List",
          },
          {
            href: "/admin/fanbattlearena-management/add-battlearena",
            label: "Add Fan Battle Arena",
          },
          {
            href: "/admin/fanbattlearena-management/battlearena-list",
            label: "Fan Battle Arena List",
          },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/comments-management/comments-list",
            label: "All Comments",
          },
        ],
      },
      {
        label: "Post Reports Management",
        icon: "◉",
        children: [
          { href: "/admin/postreports-management", label: "All Post Reports" },
        ],
      },
      {
        ...
        children: [
          {
            href: "/admin/playlists-management/playlists-list",
            label: "All Playlists",
          },
        ],
      },
      {
        label: "Sportsfan360 Profile",
        icon: "◉",
        children: [
          {
            href: "/admin/sportsfan360profile-management/add-sportsfan360",
            label: "Add Sportsfan360 Profile",
          },
          {
            href: "/admin/sportsfan360profile-management/sportsfan360profile-list",
            label: "Sportsfan360 Profile List",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          {
            href: "/admin/spotlight-management/spotlight-list",
            label: "Spotlight List",
          },
          { href: "/admin/iplpulse-management", label: "IPL Pulse Reports" },
        ],
      },
    ...
    <>
      ...
      >
        {NAV.map((group) => (
          <div
            key={group.label}
            style={{ padding: "12px 0", borderBottom: "1px solid #21282f" }}
          >
            <div
              style={{
                fontSize: 10,
            ...
            {group.items.map((item) => {
              if (item.children) {
                const isOpen =
                  ...
                  (pathname.startsWith("/admin/watchalong") ||
                    pathname.startsWith("/admin/roar"));
                return (
                  <div key={item.label}>
                    <div
                      onClick={() => toggleMenu(item.label)}
